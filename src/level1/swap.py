...
f32_instructions = [C.Machine.load_instr_f32, C.Machine.store_instr_f32, C.Machine.reg_copy_instr_f32]
...
f64_instructions = [C.Machine.load_instr_f64, C.Machine.store_instr_f64, C.Machine.reg_copy_instr_f64]
if None not in f64_instructions:
    ...
    exo_dswap_stride_1 = rename(exo_dswap_stride_1, exo_dswap_stride_1.name() + "_stride_1")
