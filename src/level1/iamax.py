...
if None not in f32_instructions:
    exo_isamax_stride_1 = schedule_iamax_stride_1(exo_isamax, C.Machine.vec_width, C.Machine.mem_type, f32_instructions, "f32")
else:
...
if None not in f64_instructions:
    exo_idamax_stride_1 = schedule_iamax_stride_1(exo_idamax, C.Machine.vec_width // 2, C.Machine.mem_type, f64_instructions, "f64")
else:
    exo_idamax_stride_1 = exo_idamax
    exo_idamax_stride_1 = rename(exo_idamax_stride_1, exo_idamax_stride_1.name() + "_stride_1")

entry_points = [exo_isamax_stride_any, exo_isamax_stride_1, exo_idamax_stride_any, exo_idamax_stride_1]
