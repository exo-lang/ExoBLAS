...
def schedule_rotm_stride_1(template, flag, VEC_W, memory, instructions, precision):
    ...
    if flag != 0:
        ...
        simple_stride_1 = stage(
            simple_stride_1, [x_compute_stmt.rhs().lhs()], "H00_Mul_X_Reg"
        )
    if flag != 1:
        x_compute_stmt = simple_stride_1.find("x[_] = _ + _")
        simple_stride_1 = stage(
            simple_stride_1, [x_compute_stmt.rhs().rhs()], "H01_Mul_Y_Reg"
        )
    x_compute_stmt = simple_stride_1.find("x[_] = _ + _")
    simple_stride_1 = stage(
        simple_stride_1, [x_compute_stmt.rhs()], "H00X_Add_H01Y_Reg"
    )
    if flag != 1:
        y_compute_stmt = simple_stride_1.find("yReg[_] = _ + _")
        simple_stride_1 = stage(
            simple_stride_1, [y_compute_stmt.rhs().lhs()], "H10_Mul_X_Reg"
        )
    if flag != 0:
        y_compute_stmt = simple_stride_1.find("yReg[_] = _ + _")
        simple_stride_1 = stage(
            simple_stride_1, [y_compute_stmt.rhs().rhs()], "H11_Mul_Y_Reg"
        )
...
if None not in f32_instructions:
    srotm_flag_neg_one_stride_1 = schedule_rotm_stride_1(
        rotm_template_flag_neg_one,
        -1,
        C.Machine.vec_width,
        C.Machine.mem_type,
        f32_instructions,
...
if None not in f32_instructions:
    srotm_flag_zero_stride_1 = schedule_rotm_stride_1(
        rotm_template_flag_zero,
        0,
        C.Machine.vec_width,
        C.Machine.mem_type,
        f32_instructions,
...
if None not in f32_instructions:
    srotm_flag_one_stride_1 = schedule_rotm_stride_1(
        rotm_template_flag_one,
        1,
        C.Machine.vec_width,
        C.Machine.mem_type,
        f32_instructions,
...
if None not in f64_instructions:
    drotm_flag_neg_one_stride_1 = schedule_rotm_stride_1(
        rotm_template_flag_neg_one,
        -1,
...
if None not in f64_instructions:
    drotm_flag_zero_stride_1 = schedule_rotm_stride_1(
        rotm_template_flag_zero,
        0,
        C.Machine.vec_width // 2,
        C.Machine.mem_type,
...
if None not in f64_instructions:
    drotm_flag_one_stride_1 = schedule_rotm_stride_1(
        rotm_template_flag_one,
        1,
        C.Machine.vec_width // 2,
        C.Machine.mem_type,
...
entry_points = [
    exo_srotm_stride_any,
    exo_srotm_stride_1,
    exo_drotm_stride_any,
    exo_drotm_stride_1,
]
