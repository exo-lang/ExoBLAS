...
exo_sasum_stride_any = rename(
    exo_sasum_stride_any, exo_sasum_stride_any.name() + "_stride_any"
)
...
if None not in f32_instructions:
    exo_sasum_stride_1 = schedule_asum_stride_1_interleaved(
        exo_sasum,
        C.Machine.vec_width,
        INTERLEAVE_FACTOR,
        C.Machine.mem_type,
...
exo_dasum_stride_any = rename(
    exo_dasum_stride_any, exo_dasum_stride_any.name() + "_stride_any"
)
...
if None not in f64_instructions:
    exo_dasum_stride_1 = schedule_asum_stride_1_interleaved(
        exo_dasum,
