...
class SYR2K:
    def __init__(
        ...
        syr2k_lower_notranspose_noalpha = self.specialize_sy2rk(
            syr2k_lower_notranspose_noalpha, precision, ["A", "B", "C", "alpha", "beta"]
        )
...
ssyr2k = SYR2K(C.Machine, "f32", k_blk, m_blk, m_reg, n_reg)
