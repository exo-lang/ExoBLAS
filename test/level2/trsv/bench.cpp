...
static void bench(benchmark::State &state) {
  ...
  for (auto _ : state) {
    trsv<lib, T>(order, Uplo, TransA, Diag, N, A.data(), lda, X.data(), incX);
  }
}
...
call_bench_all(trsv, CblasRowMajor, CblasLower, CblasNoTrans, CblasNonUnit);
call_bench_all(trsv, CblasRowMajor, CblasLower, CblasTrans, CblasNonUnit);
call_bench_all(trsv, CblasRowMajor, CblasUpper, CblasNoTrans, CblasNonUnit);
call_bench_all(trsv, CblasRowMajor, CblasUpper, CblasTrans, CblasNonUnit);
call_bench_all(trsv, CblasRowMajor, CblasLower, CblasNoTrans, CblasUnit);
call_bench_all(trsv, CblasRowMajor, CblasLower, CblasTrans, CblasUnit);
call_bench_all(trsv, CblasRowMajor, CblasUpper, CblasNoTrans, CblasUnit);
call_bench_all(trsv, CblasRowMajor, CblasUpper, CblasTrans, CblasUnit);
