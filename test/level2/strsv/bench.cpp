...
BENCHMARK(BM_cblas_strsv)->ArgNames({"N", "order", "Uplo", "TransA", "Diag", "lda_diff", "incX", "alignmentX", "alignmentA"})->ArgsProduct({
      benchmark::CreateRange(1, (1 << 13), 2), {0}, {0, 1}, {0, 1}, {0, 1}, {0, 1}, {1}, {64}, {64}
    })->ArgsProduct({
      benchmark::CreateRange(7, 7 * 7 * 7 * 7, 7), {0}, {0, 1}, {0, 1}, {0, 1}, {0, 1}, {1}, {64}, {64}
    });
BENCHMARK(BM_exo_strsv)->ArgNames({"N", "order", "Uplo", "TransA", "Diag", "lda_diff", "incX", "alignmentX", "alignmentA"})->ArgsProduct({
      benchmark::CreateRange(1, (1 << 13), 2), {0}, {0, 1}, {0, 1}, {0, 1}, {0, 1}, {1}, {64}, {64}
    })->ArgsProduct({
      benchmark::CreateRange(7, 7 * 7 * 7 * 7, 7), {0}, {0, 1}, {0, 1}, {0, 1}, {0, 1}, {1}, {64}, {64}
    });
