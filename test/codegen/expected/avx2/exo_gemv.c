...
for (int_fast32_t io = 0; io < ((m) / (4)); io++) {
  ...
  for (int_fast32_t joo = 0; joo < ((n) / (8)); joo++) {
    ...
    yReg[0] = var2[0];
    yReg[1] = var2[1];
    var0[0] = _mm256_broadcast_sd(&alphaXi[1]);
    var0[1] = _mm256_broadcast_sd(&alphaXi[1]);
    var1[0] = _mm256_loadu_pd(&A.data[(1 + 4 * io) * (A.strides[0]) + 8 * joo]);
    var1[1] = _mm256_loadu_pd(&A.data[(1 + 4 * io) * (A.strides[0]) + 4 + 8 * joo]);
    var2[0] = yReg[0];
    var2[1] = yReg[1];
    var2[0] = _mm256_fmadd_pd(var0[0], var1[0], var2[0]);
    var2[1] = _mm256_fmadd_pd(var0[1], var1[1], var2[1]);
    yReg[0] = var2[0];
    yReg[1] = var2[1];
    var0[0] = _mm256_broadcast_sd(&alphaXi[2]);
    var0[1] = _mm256_broadcast_sd(&alphaXi[2]);
    var1[0] = _mm256_loadu_pd(&A.data[(2 + 4 * io) * (A.strides[0]) + 8 * joo]);
    var1[1] = _mm256_loadu_pd(&A.data[(2 + 4 * io) * (A.strides[0]) + 4 + 8 * joo]);
    var2[0] = yReg[0];
    var2[1] = yReg[1];
    var2[0] = _mm256_fmadd_pd(var0[0], var1[0], var2[0]);
    var2[1] = _mm256_fmadd_pd(var0[1], var1[1], var2[1]);
    yReg[0] = var2[0];
    yReg[1] = var2[1];
    var0[0] = _mm256_broadcast_sd(&alphaXi[3]);
    var0[1] = _mm256_broadcast_sd(&alphaXi[3]);
    var1[0] = _mm256_loadu_pd(&A.data[(3 + 4 * io) * (A.strides[0]) + 8 * joo]);
    var1[1] = _mm256_loadu_pd(&A.data[(3 + 4 * io) * (A.strides[0]) + 4 + 8 * joo]);
    var2[0] = yReg[0];
    var2[1] = yReg[1];
    var2[0] = _mm256_fmadd_pd(var0[0], var1[0], var2[0]);
    var2[1] = _mm256_fmadd_pd(var0[1], var1[1], var2[1]);
...
for (int_fast32_t io = 0; io < ((m) / (8)); io++) {
  ...
  for (int_fast32_t joo = 0; joo < ((n) / (16)); joo++) {
    ...
    yReg[0] = var2[0];
    yReg[1] = var2[1];
    var0[0] = _mm256_broadcast_ss(&alphaXi[1]);
    var0[1] = _mm256_broadcast_ss(&alphaXi[1]);
    var1[0] = _mm256_loadu_ps(&A.data[(1 + 8 * io) * (A.strides[0]) + 16 * joo]);
    var1[1] = _mm256_loadu_ps(&A.data[(1 + 8 * io) * (A.strides[0]) + 8 + 16 * joo]);
    var2[0] = yReg[0];
    var2[1] = yReg[1];
    var2[0] = _mm256_fmadd_ps(var0[0], var1[0], var2[0]);
    var2[1] = _mm256_fmadd_ps(var0[1], var1[1], var2[1]);
    yReg[0] = var2[0];
    yReg[1] = var2[1];
    var0[0] = _mm256_broadcast_ss(&alphaXi[2]);
    var0[1] = _mm256_broadcast_ss(&alphaXi[2]);
    var1[0] = _mm256_loadu_ps(&A.data[(2 + 8 * io) * (A.strides[0]) + 16 * joo]);
    var1[1] = _mm256_loadu_ps(&A.data[(2 + 8 * io) * (A.strides[0]) + 8 + 16 * joo]);
    var2[0] = yReg[0];
    var2[1] = yReg[1];
    var2[0] = _mm256_fmadd_ps(var0[0], var1[0], var2[0]);
    var2[1] = _mm256_fmadd_ps(var0[1], var1[1], var2[1]);
    yReg[0] = var2[0];
    yReg[1] = var2[1];
    var0[0] = _mm256_broadcast_ss(&alphaXi[3]);
    var0[1] = _mm256_broadcast_ss(&alphaXi[3]);
    var1[0] = _mm256_loadu_ps(&A.data[(3 + 8 * io) * (A.strides[0]) + 16 * joo]);
    var1[1] = _mm256_loadu_ps(&A.data[(3 + 8 * io) * (A.strides[0]) + 8 + 16 * joo]);
    var2[0] = yReg[0];
    var2[1] = yReg[1];
    var2[0] = _mm256_fmadd_ps(var0[0], var1[0], var2[0]);
    var2[1] = _mm256_fmadd_ps(var0[1], var1[1], var2[1]);
    yReg[0] = var2[0];
    yReg[1] = var2[1];
    var0[0] = _mm256_broadcast_ss(&alphaXi[4]);
    var0[1] = _mm256_broadcast_ss(&alphaXi[4]);
    var1[0] = _mm256_loadu_ps(&A.data[(4 + 8 * io) * (A.strides[0]) + 16 * joo]);
    var1[1] = _mm256_loadu_ps(&A.data[(4 + 8 * io) * (A.strides[0]) + 8 + 16 * joo]);
    var2[0] = yReg[0];
    var2[1] = yReg[1];
    var2[0] = _mm256_fmadd_ps(var0[0], var1[0], var2[0]);
    var2[1] = _mm256_fmadd_ps(var0[1], var1[1], var2[1]);
    yReg[0] = var2[0];
    yReg[1] = var2[1];
    var0[0] = _mm256_broadcast_ss(&alphaXi[5]);
    var0[1] = _mm256_broadcast_ss(&alphaXi[5]);
    var1[0] = _mm256_loadu_ps(&A.data[(5 + 8 * io) * (A.strides[0]) + 16 * joo]);
    var1[1] = _mm256_loadu_ps(&A.data[(5 + 8 * io) * (A.strides[0]) + 8 + 16 * joo]);
    var2[0] = yReg[0];
    var2[1] = yReg[1];
    var2[0] = _mm256_fmadd_ps(var0[0], var1[0], var2[0]);
    var2[1] = _mm256_fmadd_ps(var0[1], var1[1], var2[1]);
    yReg[0] = var2[0];
    yReg[1] = var2[1];
    var0[0] = _mm256_broadcast_ss(&alphaXi[6]);
    var0[1] = _mm256_broadcast_ss(&alphaXi[6]);
    var1[0] = _mm256_loadu_ps(&A.data[(6 + 8 * io) * (A.strides[0]) + 16 * joo]);
    var1[1] = _mm256_loadu_ps(&A.data[(6 + 8 * io) * (A.strides[0]) + 8 + 16 * joo]);
    var2[0] = yReg[0];
    var2[1] = yReg[1];
    var2[0] = _mm256_fmadd_ps(var0[0], var1[0], var2[0]);
    var2[1] = _mm256_fmadd_ps(var0[1], var1[1], var2[1]);
    yReg[0] = var2[0];
    yReg[1] = var2[1];
    var0[0] = _mm256_broadcast_ss(&alphaXi[7]);
    var0[1] = _mm256_broadcast_ss(&alphaXi[7]);
    var1[0] = _mm256_loadu_ps(&A.data[(7 + 8 * io) * (A.strides[0]) + 16 * joo]);
    var1[1] = _mm256_loadu_ps(&A.data[(7 + 8 * io) * (A.strides[0]) + 8 + 16 * joo]);
    var2[0] = yReg[0];
    var2[1] = yReg[1];
    var2[0] = _mm256_fmadd_ps(var0[0], var1[0], var2[0]);
    var2[1] = _mm256_fmadd_ps(var0[1], var1[1], var2[1]);
