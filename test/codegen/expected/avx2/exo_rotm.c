...
for (int_fast32_t ioo = 0; ioo < ((((3 + n) / (4)) - 1) / (4)); ioo++) {
  ...
  var1[0] = _mm256_mul_pd(var0, xReg[0]);
  var1[1] = _mm256_mul_pd(var0, xReg[1]);
  var1[2] = _mm256_mul_pd(var0, xReg[2]);
  var1[3] = _mm256_mul_pd(var0, xReg[3]);
  var3[0] = _mm256_mul_pd(var2, yReg[0]);
  var3[1] = _mm256_mul_pd(var2, yReg[1]);
  var3[2] = _mm256_mul_pd(var2, yReg[2]);
  var3[3] = _mm256_mul_pd(var2, yReg[3]);
  ...
  var6[0] = _mm256_mul_pd(var5, xReg[0]);
  var6[1] = _mm256_mul_pd(var5, xReg[1]);
  var6[2] = _mm256_mul_pd(var5, xReg[2]);
  var6[3] = _mm256_mul_pd(var5, xReg[3]);
  var8[0] = _mm256_mul_pd(var7, yReg[0]);
  var8[1] = _mm256_mul_pd(var7, yReg[1]);
  var8[2] = _mm256_mul_pd(var7, yReg[2]);
  var8[3] = _mm256_mul_pd(var7, yReg[3]);
...
for (int_fast32_t io = ((3 + n) / (4)) - 1; io < ((3 + n) / (4)); io++) {
  ...
  __m256d var0_1;
    ...
    __m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
    var0_1 = _mm256_blendv_pd (_mm256_setzero_pd(), _mm256_broadcast_sd(&H[0]), _mm256_castsi256_pd(cmp));
    }
...
__m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
__m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
__m256d mul = _mm256_mul_pd(var0_1, xReg);
var1 = _mm256_blendv_pd (var1, mul, _mm256_castsi256_pd(cmp));
  ...
  __m256d var2_1;
    ...
    __m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
    var2_1 = _mm256_blendv_pd (_mm256_setzero_pd(), _mm256_broadcast_sd(&H[1]), _mm256_castsi256_pd(cmp));
    }
...
__m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
__m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
__m256d mul = _mm256_mul_pd(var2_1, yReg);
...
var4 = _mm256_blendv_pd (var4, add, _mm256_castsi256_pd(cmp));
  ...
  __m256d var5_1;
    ...
    __m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
    var5_1 = _mm256_blendv_pd (_mm256_setzero_pd(), _mm256_broadcast_sd(&H[2]), _mm256_castsi256_pd(cmp));
    }
...
__m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
__m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
__m256d mul = _mm256_mul_pd(var5_1, xReg);
var6 = _mm256_blendv_pd (var6, mul, _mm256_castsi256_pd(cmp));
  ...
  __m256d var7_1;
    ...
    __m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
    var7_1 = _mm256_blendv_pd (_mm256_setzero_pd(), _mm256_broadcast_sd(&H[2 + 1]), _mm256_castsi256_pd(cmp));
    }
...
__m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
__m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
__m256d mul = _mm256_mul_pd(var7_1, yReg);
...
for (int_fast32_t ioo = 0; ioo < ((((3 + n) / (4)) - 1) / (4)); ioo++) {
  ...
  var5[0] = _mm256_mul_pd(var4, yReg[0]);
  var5[1] = _mm256_mul_pd(var4, yReg[1]);
  var5[2] = _mm256_mul_pd(var4, yReg[2]);
  var5[3] = _mm256_mul_pd(var4, yReg[3]);
...
var3 = _mm256_blendv_pd (var3, src_sign, _mm256_castsi256_pd(cmp));
  ...
  __m256d var4_1;
    ...
    __m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
    var4_1 = _mm256_blendv_pd (_mm256_setzero_pd(), _mm256_broadcast_sd(&H[2 + 1]), _mm256_castsi256_pd(cmp));
    }
...
__m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
__m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
__m256d mul = _mm256_mul_pd(var4_1, yReg);
...
for (int_fast32_t ioo = 0; ioo < ((((3 + n) / (4)) - 1) / (4)); ioo++) {
  ...
  yReg[2] = _mm256_loadu_pd(&y.data[8 + 16 * ioo]);
  yReg[3] = _mm256_loadu_pd(&y.data[12 + 16 * ioo]);
  var1[0] = _mm256_mul_pd(var0, yReg[0]);
  var1[1] = _mm256_mul_pd(var0, yReg[1]);
  var1[2] = _mm256_mul_pd(var0, yReg[2]);
  var1[3] = _mm256_mul_pd(var0, yReg[3]);
  ...
  _mm256_storeu_pd(&x.data[8 + 16 * ioo], var2[2]);
  _mm256_storeu_pd(&x.data[12 + 16 * ioo], var2[3]);
  var4[0] = _mm256_mul_pd(var3, xReg[0]);
  var4[1] = _mm256_mul_pd(var3, xReg[1]);
  var4[2] = _mm256_mul_pd(var3, xReg[2]);
  var4[3] = _mm256_mul_pd(var3, xReg[3]);
...
for (int_fast32_t io = ((3 + n) / (4)) - 1; io < ((3 + n) / (4)); io++) {
  ...
  __m256d var0_1;
    ...
    __m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
    var0_1 = _mm256_blendv_pd (_mm256_setzero_pd(), _mm256_broadcast_sd(&H[1]), _mm256_castsi256_pd(cmp));
    }
...
__m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
__m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
__m256d mul = _mm256_mul_pd(var0_1, yReg);
var1 = _mm256_blendv_pd (var1, mul, _mm256_castsi256_pd(cmp));
}
...
var2 = _mm256_blendv_pd (var2, add, _mm256_castsi256_pd(cmp));
  ...
  __m256d var3_1;
    ...
    __m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
    var3_1 = _mm256_blendv_pd (_mm256_setzero_pd(), _mm256_broadcast_sd(&H[2]), _mm256_castsi256_pd(cmp));
    }
...
__m256i prefix = _mm256_set1_epi64x((-(4 * io) + n));
__m256i cmp = _mm256_cmpgt_epi64(prefix, indices);
__m256d mul = _mm256_mul_pd(var3_1, xReg);
...
for (int_fast32_t ioo = 0; ioo < ((((7 + n) / (8)) - 1) / (4)); ioo++) {
  ...
  var1[0] = _mm256_mul_ps(var0, xReg[0]);
  var1[1] = _mm256_mul_ps(var0, xReg[1]);
  var1[2] = _mm256_mul_ps(var0, xReg[2]);
  var1[3] = _mm256_mul_ps(var0, xReg[3]);
  var3[0] = _mm256_mul_ps(var2, yReg[0]);
  var3[1] = _mm256_mul_ps(var2, yReg[1]);
  var3[2] = _mm256_mul_ps(var2, yReg[2]);
  var3[3] = _mm256_mul_ps(var2, yReg[3]);
  ...
  var6[0] = _mm256_mul_ps(var5, xReg[0]);
  var6[1] = _mm256_mul_ps(var5, xReg[1]);
  var6[2] = _mm256_mul_ps(var5, xReg[2]);
  var6[3] = _mm256_mul_ps(var5, xReg[3]);
  var8[0] = _mm256_mul_ps(var7, yReg[0]);
  var8[1] = _mm256_mul_ps(var7, yReg[1]);
  var8[2] = _mm256_mul_ps(var7, yReg[2]);
  var8[3] = _mm256_mul_ps(var7, yReg[3]);
  ...
  
{
  ...
  __m256 var0_1;
    ...
    __m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
    var0_1 = _mm256_blendv_ps (_mm256_setzero_ps(), _mm256_broadcast_ss(&H[0]), _mm256_castsi256_ps(cmp));
    }
...
__m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
__m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
__m256 mul = _mm256_mul_ps(var0_1, xReg);
var1 = _mm256_blendv_ps (var1, mul, _mm256_castsi256_ps(cmp));
  ...
  __m256 var2_1;
    ...
    __m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
    var2_1 = _mm256_blendv_ps (_mm256_setzero_ps(), _mm256_broadcast_ss(&H[1]), _mm256_castsi256_ps(cmp));
    }
...
__m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
__m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
__m256 mul = _mm256_mul_ps(var2_1, yReg);
...
var4 = _mm256_blendv_ps (var4, add, _mm256_castsi256_ps(cmp));
  ...
  __m256 var5_1;
    ...
    __m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
    var5_1 = _mm256_blendv_ps (_mm256_setzero_ps(), _mm256_broadcast_ss(&H[2]), _mm256_castsi256_ps(cmp));
    }
...
__m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
__m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
__m256 mul = _mm256_mul_ps(var5_1, xReg);
var6 = _mm256_blendv_ps (var6, mul, _mm256_castsi256_ps(cmp));
  ...
  __m256 var7_1;
    ...
    __m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
    var7_1 = _mm256_blendv_ps (_mm256_setzero_ps(), _mm256_broadcast_ss(&H[2 + 1]), _mm256_castsi256_ps(cmp));
    }
...
__m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
__m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
__m256 mul = _mm256_mul_ps(var7_1, yReg);
...
for (int_fast32_t ioo = 0; ioo < ((((7 + n) / (8)) - 1) / (4)); ioo++) {
  ...
  var5[0] = _mm256_mul_ps(var4, yReg[0]);
  var5[1] = _mm256_mul_ps(var4, yReg[1]);
  var5[2] = _mm256_mul_ps(var4, yReg[2]);
  var5[3] = _mm256_mul_ps(var4, yReg[3]);
...
var3 = _mm256_blendv_ps (var3, src_sign, _mm256_castsi256_ps(cmp));
  ...
  __m256 var4_1;
    ...
    __m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
    var4_1 = _mm256_blendv_ps (_mm256_setzero_ps(), _mm256_broadcast_ss(&H[2 + 1]), _mm256_castsi256_ps(cmp));
    }
...
__m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
__m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
__m256 mul = _mm256_mul_ps(var4_1, yReg);
...
for (int_fast32_t ioo = 0; ioo < ((((7 + n) / (8)) - 1) / (4)); ioo++) {
  ...
  yReg[2] = _mm256_loadu_ps(&y.data[16 + 32 * ioo]);
  yReg[3] = _mm256_loadu_ps(&y.data[24 + 32 * ioo]);
  var1[0] = _mm256_mul_ps(var0, yReg[0]);
  var1[1] = _mm256_mul_ps(var0, yReg[1]);
  var1[2] = _mm256_mul_ps(var0, yReg[2]);
  var1[3] = _mm256_mul_ps(var0, yReg[3]);
  ...
  _mm256_storeu_ps(&x.data[16 + 32 * ioo], var2[2]);
  _mm256_storeu_ps(&x.data[24 + 32 * ioo], var2[3]);
  var4[0] = _mm256_mul_ps(var3, xReg[0]);
  var4[1] = _mm256_mul_ps(var3, xReg[1]);
  var4[2] = _mm256_mul_ps(var3, xReg[2]);
  var4[3] = _mm256_mul_ps(var3, xReg[3]);
  ...
  
{
  ...
  __m256 var0_1;
    ...
    __m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
    var0_1 = _mm256_blendv_ps (_mm256_setzero_ps(), _mm256_broadcast_ss(&H[1]), _mm256_castsi256_ps(cmp));
    }
...
__m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
__m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
__m256 mul = _mm256_mul_ps(var0_1, yReg);
var1 = _mm256_blendv_ps (var1, mul, _mm256_castsi256_ps(cmp));
}
...
var2 = _mm256_blendv_ps (var2, add, _mm256_castsi256_ps(cmp));
  ...
  __m256 var3_1;
    ...
    __m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
    __m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
    var3_1 = _mm256_blendv_ps (_mm256_setzero_ps(), _mm256_broadcast_ss(&H[2]), _mm256_castsi256_ps(cmp));
    }
...
__m256i prefix = _mm256_set1_epi32((-(8 * io) + n));
__m256i cmp = _mm256_cmpgt_epi32(prefix, indices);
__m256 mul = _mm256_mul_ps(var3_1, xReg);
