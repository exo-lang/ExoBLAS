...
for (int_fast32_t ko = 0; ko < 64; ko++) {
  __m256 reg[2];
  __m256 reg_1[2];
  reg_1[0] = _mm256_loadu_ps(&B.data[(4 * ko) * (B.strides[0])]);
  reg_1[1] = _mm256_loadu_ps(&B.data[(4 * ko) * (B.strides[0]) + 8]);
  reg[0] = _mm256_broadcast_ss(&A.data[4 * ko]);
  reg[1] = _mm256_broadcast_ss(&A.data[4 * ko]);
  C_reg[0][0] = _mm256_fmadd_ps(reg[0], reg_1[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_ps(reg[1], reg_1[1], C_reg[0][1]);
  reg[0] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko]);
  reg[1] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko]);
  C_reg[1][0] = _mm256_fmadd_ps(reg[0], reg_1[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_ps(reg[1], reg_1[1], C_reg[1][1]);
  reg[0] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko]);
  reg[1] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko]);
  C_reg[2][0] = _mm256_fmadd_ps(reg[0], reg_1[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_ps(reg[1], reg_1[1], C_reg[2][1]);
  reg[0] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko]);
  reg[1] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko]);
  C_reg[3][0] = _mm256_fmadd_ps(reg[0], reg_1[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_ps(reg[1], reg_1[1], C_reg[3][1]);
  __m256 reg_2[2];
  __m256 reg_3[2];
  reg_3[0] = _mm256_loadu_ps(&B.data[(4 * ko + 1) * (B.strides[0])]);
  reg_3[1] = _mm256_loadu_ps(&B.data[(4 * ko + 1) * (B.strides[0]) + 8]);
  reg_2[0] = _mm256_broadcast_ss(&A.data[4 * ko + 1]);
  reg_2[1] = _mm256_broadcast_ss(&A.data[4 * ko + 1]);
  C_reg[0][0] = _mm256_fmadd_ps(reg_2[0], reg_3[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_ps(reg_2[1], reg_3[1], C_reg[0][1]);
  reg_2[0] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko + 1]);
  reg_2[1] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko + 1]);
  C_reg[1][0] = _mm256_fmadd_ps(reg_2[0], reg_3[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_ps(reg_2[1], reg_3[1], C_reg[1][1]);
  reg_2[0] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko + 1]);
  reg_2[1] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko + 1]);
  C_reg[2][0] = _mm256_fmadd_ps(reg_2[0], reg_3[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_ps(reg_2[1], reg_3[1], C_reg[2][1]);
  reg_2[0] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko + 1]);
  reg_2[1] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko + 1]);
  C_reg[3][0] = _mm256_fmadd_ps(reg_2[0], reg_3[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_ps(reg_2[1], reg_3[1], C_reg[3][1]);
  __m256 reg_4[2];
  __m256 reg_5[2];
  reg_5[0] = _mm256_loadu_ps(&B.data[(4 * ko + 2) * (B.strides[0])]);
  reg_5[1] = _mm256_loadu_ps(&B.data[(4 * ko + 2) * (B.strides[0]) + 8]);
  reg_4[0] = _mm256_broadcast_ss(&A.data[4 * ko + 2]);
  reg_4[1] = _mm256_broadcast_ss(&A.data[4 * ko + 2]);
  C_reg[0][0] = _mm256_fmadd_ps(reg_4[0], reg_5[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_ps(reg_4[1], reg_5[1], C_reg[0][1]);
  reg_4[0] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko + 2]);
  reg_4[1] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko + 2]);
  C_reg[1][0] = _mm256_fmadd_ps(reg_4[0], reg_5[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_ps(reg_4[1], reg_5[1], C_reg[1][1]);
  reg_4[0] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko + 2]);
  reg_4[1] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko + 2]);
  C_reg[2][0] = _mm256_fmadd_ps(reg_4[0], reg_5[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_ps(reg_4[1], reg_5[1], C_reg[2][1]);
  reg_4[0] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko + 2]);
  reg_4[1] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko + 2]);
  C_reg[3][0] = _mm256_fmadd_ps(reg_4[0], reg_5[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_ps(reg_4[1], reg_5[1], C_reg[3][1]);
  __m256 reg_6[2];
  __m256 reg_7[2];
  reg_7[0] = _mm256_loadu_ps(&B.data[(4 * ko + 3) * (B.strides[0])]);
  reg_7[1] = _mm256_loadu_ps(&B.data[(4 * ko + 3) * (B.strides[0]) + 8]);
  reg_6[0] = _mm256_broadcast_ss(&A.data[4 * ko + 3]);
  reg_6[1] = _mm256_broadcast_ss(&A.data[4 * ko + 3]);
  C_reg[0][0] = _mm256_fmadd_ps(reg_6[0], reg_7[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_ps(reg_6[1], reg_7[1], C_reg[0][1]);
  reg_6[0] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko + 3]);
  reg_6[1] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko + 3]);
  C_reg[1][0] = _mm256_fmadd_ps(reg_6[0], reg_7[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_ps(reg_6[1], reg_7[1], C_reg[1][1]);
  reg_6[0] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko + 3]);
  reg_6[1] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko + 3]);
  C_reg[2][0] = _mm256_fmadd_ps(reg_6[0], reg_7[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_ps(reg_6[1], reg_7[1], C_reg[2][1]);
  reg_6[0] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko + 3]);
  reg_6[1] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko + 3]);
...
for (int_fast32_t ko = 0; ko < 64; ko++) {
  __m256d reg[2];
  __m256d reg_1[2];
  reg_1[0] = _mm256_loadu_pd(&B.data[(4 * ko) * (B.strides[0])]);
  reg_1[1] = _mm256_loadu_pd(&B.data[(4 * ko) * (B.strides[0]) + 4]);
  reg[0] = _mm256_broadcast_sd(&A.data[4 * ko]);
  reg[1] = _mm256_broadcast_sd(&A.data[4 * ko]);
  C_reg[0][0] = _mm256_fmadd_pd(reg[0], reg_1[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_pd(reg[1], reg_1[1], C_reg[0][1]);
  reg[0] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko]);
  reg[1] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko]);
  C_reg[1][0] = _mm256_fmadd_pd(reg[0], reg_1[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_pd(reg[1], reg_1[1], C_reg[1][1]);
  reg[0] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko]);
  reg[1] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko]);
  C_reg[2][0] = _mm256_fmadd_pd(reg[0], reg_1[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_pd(reg[1], reg_1[1], C_reg[2][1]);
  reg[0] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko]);
  reg[1] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko]);
  C_reg[3][0] = _mm256_fmadd_pd(reg[0], reg_1[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_pd(reg[1], reg_1[1], C_reg[3][1]);
  __m256d reg_2[2];
  __m256d reg_3[2];
  reg_3[0] = _mm256_loadu_pd(&B.data[(4 * ko + 1) * (B.strides[0])]);
  reg_3[1] = _mm256_loadu_pd(&B.data[(4 * ko + 1) * (B.strides[0]) + 4]);
  reg_2[0] = _mm256_broadcast_sd(&A.data[4 * ko + 1]);
  reg_2[1] = _mm256_broadcast_sd(&A.data[4 * ko + 1]);
  C_reg[0][0] = _mm256_fmadd_pd(reg_2[0], reg_3[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_pd(reg_2[1], reg_3[1], C_reg[0][1]);
  reg_2[0] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko + 1]);
  reg_2[1] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko + 1]);
  C_reg[1][0] = _mm256_fmadd_pd(reg_2[0], reg_3[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_pd(reg_2[1], reg_3[1], C_reg[1][1]);
  reg_2[0] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko + 1]);
  reg_2[1] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko + 1]);
  C_reg[2][0] = _mm256_fmadd_pd(reg_2[0], reg_3[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_pd(reg_2[1], reg_3[1], C_reg[2][1]);
  reg_2[0] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko + 1]);
  reg_2[1] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko + 1]);
  C_reg[3][0] = _mm256_fmadd_pd(reg_2[0], reg_3[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_pd(reg_2[1], reg_3[1], C_reg[3][1]);
  __m256d reg_4[2];
  __m256d reg_5[2];
  reg_5[0] = _mm256_loadu_pd(&B.data[(4 * ko + 2) * (B.strides[0])]);
  reg_5[1] = _mm256_loadu_pd(&B.data[(4 * ko + 2) * (B.strides[0]) + 4]);
  reg_4[0] = _mm256_broadcast_sd(&A.data[4 * ko + 2]);
  reg_4[1] = _mm256_broadcast_sd(&A.data[4 * ko + 2]);
  C_reg[0][0] = _mm256_fmadd_pd(reg_4[0], reg_5[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_pd(reg_4[1], reg_5[1], C_reg[0][1]);
  reg_4[0] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko + 2]);
  reg_4[1] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko + 2]);
  C_reg[1][0] = _mm256_fmadd_pd(reg_4[0], reg_5[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_pd(reg_4[1], reg_5[1], C_reg[1][1]);
  reg_4[0] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko + 2]);
  reg_4[1] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko + 2]);
  C_reg[2][0] = _mm256_fmadd_pd(reg_4[0], reg_5[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_pd(reg_4[1], reg_5[1], C_reg[2][1]);
  reg_4[0] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko + 2]);
  reg_4[1] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko + 2]);
  C_reg[3][0] = _mm256_fmadd_pd(reg_4[0], reg_5[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_pd(reg_4[1], reg_5[1], C_reg[3][1]);
  __m256d reg_6[2];
  __m256d reg_7[2];
  reg_7[0] = _mm256_loadu_pd(&B.data[(4 * ko + 3) * (B.strides[0])]);
  reg_7[1] = _mm256_loadu_pd(&B.data[(4 * ko + 3) * (B.strides[0]) + 4]);
  reg_6[0] = _mm256_broadcast_sd(&A.data[4 * ko + 3]);
  reg_6[1] = _mm256_broadcast_sd(&A.data[4 * ko + 3]);
  C_reg[0][0] = _mm256_fmadd_pd(reg_6[0], reg_7[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_pd(reg_6[1], reg_7[1], C_reg[0][1]);
  reg_6[0] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko + 3]);
  reg_6[1] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko + 3]);
  C_reg[1][0] = _mm256_fmadd_pd(reg_6[0], reg_7[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_pd(reg_6[1], reg_7[1], C_reg[1][1]);
  reg_6[0] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko + 3]);
  reg_6[1] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko + 3]);
  C_reg[2][0] = _mm256_fmadd_pd(reg_6[0], reg_7[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_pd(reg_6[1], reg_7[1], C_reg[2][1]);
  reg_6[0] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko + 3]);
  reg_6[1] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko + 3]);
  C_reg[3][0] = _mm256_fmadd_pd(reg_6[0], reg_7[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_pd(reg_6[1], reg_7[1], C_reg[3][1]);
}
...
for (int_fast32_t jo = 0; jo < 8; jo++) {
  ...
  for (int_fast32_t io = 0; io < 32; io++) {
    ...
    for (int_fast32_t ko = 0; ko < 64; ko++) {
      __m256 reg[2];
      __m256 reg_1[2];
      reg_1[0] = _mm256_loadu_ps(&B_reg_strip[(4 * ko) * (16)]);
      reg_1[1] = _mm256_loadu_ps(&B_reg_strip[(4 * ko) * (16) + 8]);
      reg[0] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 4 * ko]);
      reg[1] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_ps(reg[0], reg_1[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_ps(reg[1], reg_1[1], C_reg[0][1]);
      reg[0] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 4 * ko]);
      reg[1] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_ps(reg[0], reg_1[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_ps(reg[1], reg_1[1], C_reg[1][1]);
      reg[0] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 4 * ko]);
      reg[1] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_ps(reg[0], reg_1[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_ps(reg[1], reg_1[1], C_reg[2][1]);
      reg[0] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 4 * ko]);
      reg[1] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_ps(reg[0], reg_1[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_ps(reg[1], reg_1[1], C_reg[3][1]);
      __m256 reg_2[2];
      __m256 reg_3[2];
      reg_3[0] = _mm256_loadu_ps(&B_reg_strip[(1 + 4 * ko) * (16)]);
      reg_3[1] = _mm256_loadu_ps(&B_reg_strip[(1 + 4 * ko) * (16) + 8]);
      reg_2[0] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      reg_2[1] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_ps(reg_2[0], reg_3[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_ps(reg_2[1], reg_3[1], C_reg[0][1]);
      reg_2[0] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      reg_2[1] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_ps(reg_2[0], reg_3[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_ps(reg_2[1], reg_3[1], C_reg[1][1]);
      reg_2[0] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      reg_2[1] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_ps(reg_2[0], reg_3[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_ps(reg_2[1], reg_3[1], C_reg[2][1]);
      reg_2[0] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      reg_2[1] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_ps(reg_2[0], reg_3[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_ps(reg_2[1], reg_3[1], C_reg[3][1]);
      __m256 reg_4[2];
      __m256 reg_5[2];
      reg_5[0] = _mm256_loadu_ps(&B_reg_strip[(2 + 4 * ko) * (16)]);
      reg_5[1] = _mm256_loadu_ps(&B_reg_strip[(2 + 4 * ko) * (16) + 8]);
      reg_4[0] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      reg_4[1] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_ps(reg_4[0], reg_5[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_ps(reg_4[1], reg_5[1], C_reg[0][1]);
      reg_4[0] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      reg_4[1] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_ps(reg_4[0], reg_5[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_ps(reg_4[1], reg_5[1], C_reg[1][1]);
      reg_4[0] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      reg_4[1] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_ps(reg_4[0], reg_5[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_ps(reg_4[1], reg_5[1], C_reg[2][1]);
      reg_4[0] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      reg_4[1] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_ps(reg_4[0], reg_5[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_ps(reg_4[1], reg_5[1], C_reg[3][1]);
      __m256 reg_6[2];
      __m256 reg_7[2];
      reg_7[0] = _mm256_loadu_ps(&B_reg_strip[(3 + 4 * ko) * (16)]);
      reg_7[1] = _mm256_loadu_ps(&B_reg_strip[(3 + 4 * ko) * (16) + 8]);
      reg_6[0] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      reg_6[1] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_ps(reg_6[0], reg_7[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_ps(reg_6[1], reg_7[1], C_reg[0][1]);
      reg_6[0] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      reg_6[1] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_ps(reg_6[0], reg_7[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_ps(reg_6[1], reg_7[1], C_reg[1][1]);
      reg_6[0] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      reg_6[1] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_ps(reg_6[0], reg_7[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_ps(reg_6[1], reg_7[1], C_reg[2][1]);
      reg_6[0] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      reg_6[1] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_ps(reg_6[0], reg_7[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_ps(reg_6[1], reg_7[1], C_reg[3][1]);
    }
...
for (int_fast32_t jo = 0; jo < 16; jo++) {
  ...
  for (int_fast32_t io = 0; io < 32; io++) {
    ...
    for (int_fast32_t ko = 0; ko < 64; ko++) {
      __m256d reg[2];
      __m256d reg_1[2];
      reg_1[0] = _mm256_loadu_pd(&B_reg_strip[(4 * ko) * 8]);
      reg_1[1] = _mm256_loadu_pd(&B_reg_strip[(4 * ko) * 8 + 4]);
      reg[0] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 4 * ko]);
      reg[1] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_pd(reg[0], reg_1[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_pd(reg[1], reg_1[1], C_reg[0][1]);
      reg[0] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 4 * ko]);
      reg[1] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_pd(reg[0], reg_1[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_pd(reg[1], reg_1[1], C_reg[1][1]);
      reg[0] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 4 * ko]);
      reg[1] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_pd(reg[0], reg_1[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_pd(reg[1], reg_1[1], C_reg[2][1]);
      reg[0] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 4 * ko]);
      reg[1] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_pd(reg[0], reg_1[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_pd(reg[1], reg_1[1], C_reg[3][1]);
      __m256d reg_2[2];
      __m256d reg_3[2];
      reg_3[0] = _mm256_loadu_pd(&B_reg_strip[(1 + 4 * ko) * 8]);
      reg_3[1] = _mm256_loadu_pd(&B_reg_strip[(1 + 4 * ko) * 8 + 4]);
      reg_2[0] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      reg_2[1] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_pd(reg_2[0], reg_3[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_pd(reg_2[1], reg_3[1], C_reg[0][1]);
      reg_2[0] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      reg_2[1] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_pd(reg_2[0], reg_3[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_pd(reg_2[1], reg_3[1], C_reg[1][1]);
      reg_2[0] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      reg_2[1] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_pd(reg_2[0], reg_3[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_pd(reg_2[1], reg_3[1], C_reg[2][1]);
      reg_2[0] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      reg_2[1] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_pd(reg_2[0], reg_3[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_pd(reg_2[1], reg_3[1], C_reg[3][1]);
      __m256d reg_4[2];
      __m256d reg_5[2];
      reg_5[0] = _mm256_loadu_pd(&B_reg_strip[(2 + 4 * ko) * 8]);
      reg_5[1] = _mm256_loadu_pd(&B_reg_strip[(2 + 4 * ko) * 8 + 4]);
      reg_4[0] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      reg_4[1] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_pd(reg_4[0], reg_5[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_pd(reg_4[1], reg_5[1], C_reg[0][1]);
      reg_4[0] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      reg_4[1] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_pd(reg_4[0], reg_5[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_pd(reg_4[1], reg_5[1], C_reg[1][1]);
      reg_4[0] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      reg_4[1] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_pd(reg_4[0], reg_5[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_pd(reg_4[1], reg_5[1], C_reg[2][1]);
      reg_4[0] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      reg_4[1] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_pd(reg_4[0], reg_5[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_pd(reg_4[1], reg_5[1], C_reg[3][1]);
      __m256d reg_6[2];
      __m256d reg_7[2];
      reg_7[0] = _mm256_loadu_pd(&B_reg_strip[(3 + 4 * ko) * 8]);
      reg_7[1] = _mm256_loadu_pd(&B_reg_strip[(3 + 4 * ko) * 8 + 4]);
      reg_6[0] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      reg_6[1] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_pd(reg_6[0], reg_7[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_pd(reg_6[1], reg_7[1], C_reg[0][1]);
      reg_6[0] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      reg_6[1] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_pd(reg_6[0], reg_7[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_pd(reg_6[1], reg_7[1], C_reg[1][1]);
      reg_6[0] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      reg_6[1] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_pd(reg_6[0], reg_7[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_pd(reg_6[1], reg_7[1], C_reg[2][1]);
      reg_6[0] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      reg_6[1] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_pd(reg_6[0], reg_7[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_pd(reg_6[1], reg_7[1], C_reg[3][1]);
    }
