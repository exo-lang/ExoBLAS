...
for (int_fast32_t ko = 0; ko < 64; ko++) {
  ...
  __m256 var0_1[2];
  var0_1[0] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko]);
  var0_1[1] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko]);
  C_reg[1][0] = _mm256_fmadd_ps(var0_1[0], var1[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_ps(var0_1[1], var1[1], C_reg[1][1]);
  __m256 var0_2[2];
  var0_2[0] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko]);
  var0_2[1] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko]);
  C_reg[2][0] = _mm256_fmadd_ps(var0_2[0], var1[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_ps(var0_2[1], var1[1], C_reg[2][1]);
  __m256 var0_3[2];
  var0_3[0] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko]);
  var0_3[1] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko]);
  ...
  __m256 var0_4[2];
  var0_4[0] = _mm256_broadcast_ss(&A.data[4 * ko + 1]);
  var0_4[1] = _mm256_broadcast_ss(&A.data[4 * ko + 1]);
  C_reg[0][0] = _mm256_fmadd_ps(var0_4[0], var1_1[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_ps(var0_4[1], var1_1[1], C_reg[0][1]);
  __m256 var0_5[2];
  var0_5[0] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko + 1]);
  var0_5[1] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko + 1]);
  C_reg[1][0] = _mm256_fmadd_ps(var0_5[0], var1_1[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_ps(var0_5[1], var1_1[1], C_reg[1][1]);
  __m256 var0_6[2];
  var0_6[0] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko + 1]);
  var0_6[1] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko + 1]);
  C_reg[2][0] = _mm256_fmadd_ps(var0_6[0], var1_1[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_ps(var0_6[1], var1_1[1], C_reg[2][1]);
  __m256 var0_7[2];
  var0_7[0] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko + 1]);
  var0_7[1] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko + 1]);
  C_reg[3][0] = _mm256_fmadd_ps(var0_7[0], var1_1[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_ps(var0_7[1], var1_1[1], C_reg[3][1]);
  __m256 var1_2[2];
  var1_2[0] = _mm256_loadu_ps(&B.data[(4 * ko + 2) * (B.strides[0])]);
  var1_2[1] = _mm256_loadu_ps(&B.data[(4 * ko + 2) * (B.strides[0]) + 8]);
  __m256 var0_8[2];
  var0_8[0] = _mm256_broadcast_ss(&A.data[4 * ko + 2]);
  var0_8[1] = _mm256_broadcast_ss(&A.data[4 * ko + 2]);
  C_reg[0][0] = _mm256_fmadd_ps(var0_8[0], var1_2[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_ps(var0_8[1], var1_2[1], C_reg[0][1]);
  __m256 var0_9[2];
  var0_9[0] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko + 2]);
  var0_9[1] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko + 2]);
  C_reg[1][0] = _mm256_fmadd_ps(var0_9[0], var1_2[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_ps(var0_9[1], var1_2[1], C_reg[1][1]);
  __m256 var0_10[2];
  var0_10[0] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko + 2]);
  var0_10[1] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko + 2]);
  C_reg[2][0] = _mm256_fmadd_ps(var0_10[0], var1_2[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_ps(var0_10[1], var1_2[1], C_reg[2][1]);
  __m256 var0_11[2];
  var0_11[0] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko + 2]);
  var0_11[1] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko + 2]);
  C_reg[3][0] = _mm256_fmadd_ps(var0_11[0], var1_2[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_ps(var0_11[1], var1_2[1], C_reg[3][1]);
  __m256 var1_3[2];
  var1_3[0] = _mm256_loadu_ps(&B.data[(4 * ko + 3) * (B.strides[0])]);
  var1_3[1] = _mm256_loadu_ps(&B.data[(4 * ko + 3) * (B.strides[0]) + 8]);
  __m256 var0_12[2];
  var0_12[0] = _mm256_broadcast_ss(&A.data[4 * ko + 3]);
  var0_12[1] = _mm256_broadcast_ss(&A.data[4 * ko + 3]);
  C_reg[0][0] = _mm256_fmadd_ps(var0_12[0], var1_3[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_ps(var0_12[1], var1_3[1], C_reg[0][1]);
  __m256 var0_13[2];
  var0_13[0] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko + 3]);
  var0_13[1] = _mm256_broadcast_ss(&A.data[A.strides[0] + 4 * ko + 3]);
  C_reg[1][0] = _mm256_fmadd_ps(var0_13[0], var1_3[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_ps(var0_13[1], var1_3[1], C_reg[1][1]);
  __m256 var0_14[2];
  var0_14[0] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko + 3]);
  var0_14[1] = _mm256_broadcast_ss(&A.data[(2) * (A.strides[0]) + 4 * ko + 3]);
  C_reg[2][0] = _mm256_fmadd_ps(var0_14[0], var1_3[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_ps(var0_14[1], var1_3[1], C_reg[2][1]);
  __m256 var0_15[2];
  var0_15[0] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko + 3]);
  var0_15[1] = _mm256_broadcast_ss(&A.data[(3) * (A.strides[0]) + 4 * ko + 3]);
  C_reg[3][0] = _mm256_fmadd_ps(var0_15[0], var1_3[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_ps(var0_15[1], var1_3[1], C_reg[3][1]);
}
...
for (int_fast32_t ko = 0; ko < 64; ko++) {
  ...
  __m256d var0_1[2];
  var0_1[0] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko]);
  var0_1[1] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko]);
  C_reg[1][0] = _mm256_fmadd_pd(var0_1[0], var1[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_pd(var0_1[1], var1[1], C_reg[1][1]);
  __m256d var0_2[2];
  var0_2[0] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko]);
  var0_2[1] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko]);
  C_reg[2][0] = _mm256_fmadd_pd(var0_2[0], var1[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_pd(var0_2[1], var1[1], C_reg[2][1]);
  __m256d var0_3[2];
  var0_3[0] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko]);
  var0_3[1] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko]);
  C_reg[3][0] = _mm256_fmadd_pd(var0_3[0], var1[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_pd(var0_3[1], var1[1], C_reg[3][1]);
  __m256d var1_1[2];
  var1_1[0] = _mm256_loadu_pd(&B.data[(4 * ko + 1) * (B.strides[0])]);
  var1_1[1] = _mm256_loadu_pd(&B.data[(4 * ko + 1) * (B.strides[0]) + 4]);
  __m256d var0_4[2];
  var0_4[0] = _mm256_broadcast_sd(&A.data[4 * ko + 1]);
  var0_4[1] = _mm256_broadcast_sd(&A.data[4 * ko + 1]);
  C_reg[0][0] = _mm256_fmadd_pd(var0_4[0], var1_1[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_pd(var0_4[1], var1_1[1], C_reg[0][1]);
  __m256d var0_5[2];
  var0_5[0] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko + 1]);
  var0_5[1] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko + 1]);
  C_reg[1][0] = _mm256_fmadd_pd(var0_5[0], var1_1[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_pd(var0_5[1], var1_1[1], C_reg[1][1]);
  __m256d var0_6[2];
  var0_6[0] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko + 1]);
  var0_6[1] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko + 1]);
  C_reg[2][0] = _mm256_fmadd_pd(var0_6[0], var1_1[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_pd(var0_6[1], var1_1[1], C_reg[2][1]);
  __m256d var0_7[2];
  var0_7[0] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko + 1]);
  var0_7[1] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko + 1]);
  C_reg[3][0] = _mm256_fmadd_pd(var0_7[0], var1_1[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_pd(var0_7[1], var1_1[1], C_reg[3][1]);
  __m256d var1_2[2];
  var1_2[0] = _mm256_loadu_pd(&B.data[(4 * ko + 2) * (B.strides[0])]);
  var1_2[1] = _mm256_loadu_pd(&B.data[(4 * ko + 2) * (B.strides[0]) + 4]);
  __m256d var0_8[2];
  var0_8[0] = _mm256_broadcast_sd(&A.data[4 * ko + 2]);
  var0_8[1] = _mm256_broadcast_sd(&A.data[4 * ko + 2]);
  C_reg[0][0] = _mm256_fmadd_pd(var0_8[0], var1_2[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_pd(var0_8[1], var1_2[1], C_reg[0][1]);
  __m256d var0_9[2];
  var0_9[0] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko + 2]);
  var0_9[1] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko + 2]);
  C_reg[1][0] = _mm256_fmadd_pd(var0_9[0], var1_2[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_pd(var0_9[1], var1_2[1], C_reg[1][1]);
  __m256d var0_10[2];
  var0_10[0] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko + 2]);
  var0_10[1] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko + 2]);
  C_reg[2][0] = _mm256_fmadd_pd(var0_10[0], var1_2[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_pd(var0_10[1], var1_2[1], C_reg[2][1]);
  __m256d var0_11[2];
  var0_11[0] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko + 2]);
  var0_11[1] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko + 2]);
  C_reg[3][0] = _mm256_fmadd_pd(var0_11[0], var1_2[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_pd(var0_11[1], var1_2[1], C_reg[3][1]);
  __m256d var1_3[2];
  var1_3[0] = _mm256_loadu_pd(&B.data[(4 * ko + 3) * (B.strides[0])]);
  var1_3[1] = _mm256_loadu_pd(&B.data[(4 * ko + 3) * (B.strides[0]) + 4]);
  __m256d var0_12[2];
  var0_12[0] = _mm256_broadcast_sd(&A.data[4 * ko + 3]);
  var0_12[1] = _mm256_broadcast_sd(&A.data[4 * ko + 3]);
  C_reg[0][0] = _mm256_fmadd_pd(var0_12[0], var1_3[0], C_reg[0][0]);
  C_reg[0][1] = _mm256_fmadd_pd(var0_12[1], var1_3[1], C_reg[0][1]);
  __m256d var0_13[2];
  var0_13[0] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko + 3]);
  var0_13[1] = _mm256_broadcast_sd(&A.data[A.strides[0] + 4 * ko + 3]);
  C_reg[1][0] = _mm256_fmadd_pd(var0_13[0], var1_3[0], C_reg[1][0]);
  C_reg[1][1] = _mm256_fmadd_pd(var0_13[1], var1_3[1], C_reg[1][1]);
  __m256d var0_14[2];
  var0_14[0] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko + 3]);
  var0_14[1] = _mm256_broadcast_sd(&A.data[(2) * (A.strides[0]) + 4 * ko + 3]);
  C_reg[2][0] = _mm256_fmadd_pd(var0_14[0], var1_3[0], C_reg[2][0]);
  C_reg[2][1] = _mm256_fmadd_pd(var0_14[1], var1_3[1], C_reg[2][1]);
  __m256d var0_15[2];
  var0_15[0] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko + 3]);
  var0_15[1] = _mm256_broadcast_sd(&A.data[(3) * (A.strides[0]) + 4 * ko + 3]);
  C_reg[3][0] = _mm256_fmadd_pd(var0_15[0], var1_3[0], C_reg[3][0]);
  C_reg[3][1] = _mm256_fmadd_pd(var0_15[1], var1_3[1], C_reg[3][1]);
}
...
for (int_fast32_t jo = 0; jo < 8; jo++) {
  ...
  for (int_fast32_t io = 0; io < 32; io++) {
    ...
    for (int_fast32_t ko = 0; ko < 64; ko++) {
      ...
      C_reg[0][1] = _mm256_fmadd_ps(var0[1], var1[1], C_reg[0][1]);
      __m256 var0_1[2];
      var0_1[0] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 4 * ko]);
      var0_1[1] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_ps(var0_1[0], var1[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_ps(var0_1[1], var1[1], C_reg[1][1]);
      __m256 var0_2[2];
      var0_2[0] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 4 * ko]);
      var0_2[1] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_ps(var0_2[0], var1[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_ps(var0_2[1], var1[1], C_reg[2][1]);
      __m256 var0_3[2];
      var0_3[0] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 4 * ko]);
      var0_3[1] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_ps(var0_3[0], var1[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_ps(var0_3[1], var1[1], C_reg[3][1]);
      __m256 var1_1[2];
      ...
      __m256 var0_4[2];
      var0_4[0] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      var0_4[1] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_ps(var0_4[0], var1_1[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_ps(var0_4[1], var1_1[1], C_reg[0][1]);
      __m256 var0_5[2];
      var0_5[0] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      var0_5[1] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_ps(var0_5[0], var1_1[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_ps(var0_5[1], var1_1[1], C_reg[1][1]);
      __m256 var0_6[2];
      var0_6[0] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      var0_6[1] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_ps(var0_6[0], var1_1[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_ps(var0_6[1], var1_1[1], C_reg[2][1]);
      __m256 var0_7[2];
      var0_7[0] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      var0_7[1] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_ps(var0_7[0], var1_1[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_ps(var0_7[1], var1_1[1], C_reg[3][1]);
      __m256 var1_2[2];
      ...
      __m256 var0_8[2];
      var0_8[0] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      var0_8[1] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_ps(var0_8[0], var1_2[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_ps(var0_8[1], var1_2[1], C_reg[0][1]);
      __m256 var0_9[2];
      var0_9[0] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      var0_9[1] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_ps(var0_9[0], var1_2[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_ps(var0_9[1], var1_2[1], C_reg[1][1]);
      __m256 var0_10[2];
      var0_10[0] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      var0_10[1] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_ps(var0_10[0], var1_2[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_ps(var0_10[1], var1_2[1], C_reg[2][1]);
      __m256 var0_11[2];
      var0_11[0] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      var0_11[1] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_ps(var0_11[0], var1_2[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_ps(var0_11[1], var1_2[1], C_reg[3][1]);
      __m256 var1_3[2];
      ...
      __m256 var0_12[2];
      var0_12[0] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      var0_12[1] = _mm256_broadcast_ss(&A.data[(4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_ps(var0_12[0], var1_3[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_ps(var0_12[1], var1_3[1], C_reg[0][1]);
      __m256 var0_13[2];
      var0_13[0] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      var0_13[1] = _mm256_broadcast_ss(&A.data[(1 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_ps(var0_13[0], var1_3[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_ps(var0_13[1], var1_3[1], C_reg[1][1]);
      __m256 var0_14[2];
      var0_14[0] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      var0_14[1] = _mm256_broadcast_ss(&A.data[(2 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_ps(var0_14[0], var1_3[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_ps(var0_14[1], var1_3[1], C_reg[2][1]);
      __m256 var0_15[2];
      var0_15[0] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      var0_15[1] = _mm256_broadcast_ss(&A.data[(3 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_ps(var0_15[0], var1_3[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_ps(var0_15[1], var1_3[1], C_reg[3][1]);
    }
...
for (int_fast32_t jo = 0; jo < 16; jo++) {
  ...
  for (int_fast32_t io = 0; io < 32; io++) {
    ...
    for (int_fast32_t ko = 0; ko < 64; ko++) {
      ...
      C_reg[0][1] = _mm256_fmadd_pd(var0[1], var1[1], C_reg[0][1]);
      __m256d var0_1[2];
      var0_1[0] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 4 * ko]);
      var0_1[1] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_pd(var0_1[0], var1[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_pd(var0_1[1], var1[1], C_reg[1][1]);
      __m256d var0_2[2];
      var0_2[0] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 4 * ko]);
      var0_2[1] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_pd(var0_2[0], var1[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_pd(var0_2[1], var1[1], C_reg[2][1]);
      __m256d var0_3[2];
      var0_3[0] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 4 * ko]);
      var0_3[1] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_pd(var0_3[0], var1[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_pd(var0_3[1], var1[1], C_reg[3][1]);
      __m256d var1_1[2];
      ...
      __m256d var0_4[2];
      var0_4[0] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      var0_4[1] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_pd(var0_4[0], var1_1[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_pd(var0_4[1], var1_1[1], C_reg[0][1]);
      __m256d var0_5[2];
      var0_5[0] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      var0_5[1] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_pd(var0_5[0], var1_1[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_pd(var0_5[1], var1_1[1], C_reg[1][1]);
      __m256d var0_6[2];
      var0_6[0] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      var0_6[1] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_pd(var0_6[0], var1_1[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_pd(var0_6[1], var1_1[1], C_reg[2][1]);
      __m256d var0_7[2];
      var0_7[0] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      var0_7[1] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 1 + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_pd(var0_7[0], var1_1[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_pd(var0_7[1], var1_1[1], C_reg[3][1]);
      __m256d var1_2[2];
      ...
      __m256d var0_8[2];
      var0_8[0] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      var0_8[1] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_pd(var0_8[0], var1_2[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_pd(var0_8[1], var1_2[1], C_reg[0][1]);
      __m256d var0_9[2];
      var0_9[0] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      var0_9[1] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_pd(var0_9[0], var1_2[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_pd(var0_9[1], var1_2[1], C_reg[1][1]);
      __m256d var0_10[2];
      var0_10[0] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      var0_10[1] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_pd(var0_10[0], var1_2[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_pd(var0_10[1], var1_2[1], C_reg[2][1]);
      __m256d var0_11[2];
      var0_11[0] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      var0_11[1] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 2 + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_pd(var0_11[0], var1_2[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_pd(var0_11[1], var1_2[1], C_reg[3][1]);
      __m256d var1_3[2];
      ...
      __m256d var0_12[2];
      var0_12[0] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      var0_12[1] = _mm256_broadcast_sd(&A.data[(4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[0][0] = _mm256_fmadd_pd(var0_12[0], var1_3[0], C_reg[0][0]);
      C_reg[0][1] = _mm256_fmadd_pd(var0_12[1], var1_3[1], C_reg[0][1]);
      __m256d var0_13[2];
      var0_13[0] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      var0_13[1] = _mm256_broadcast_sd(&A.data[(1 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[1][0] = _mm256_fmadd_pd(var0_13[0], var1_3[0], C_reg[1][0]);
      C_reg[1][1] = _mm256_fmadd_pd(var0_13[1], var1_3[1], C_reg[1][1]);
      __m256d var0_14[2];
      var0_14[0] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      var0_14[1] = _mm256_broadcast_sd(&A.data[(2 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[2][0] = _mm256_fmadd_pd(var0_14[0], var1_3[0], C_reg[2][0]);
      C_reg[2][1] = _mm256_fmadd_pd(var0_14[1], var1_3[1], C_reg[2][1]);
      __m256d var0_15[2];
      var0_15[0] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      var0_15[1] = _mm256_broadcast_sd(&A.data[(3 + 4 * io) * (A.strides[0]) + 3 + 4 * ko]);
      C_reg[3][0] = _mm256_fmadd_pd(var0_15[0], var1_3[0], C_reg[3][0]);
      C_reg[3][1] = _mm256_fmadd_pd(var0_15[1], var1_3[1], C_reg[3][1]);
    }
