...
for (int_fast32_t ioo = 0; ioo < ((((3 + n) / (4)) - 1) / (4)); ioo++) {
  ...
  var4[0] = _mm256_loadu_pd(&y.data[16 * ioo]);
  var4[1] = _mm256_loadu_pd(&y.data[4 + 16 * ioo]);
  var4[2] = _mm256_loadu_pd(&y.data[8 + 16 * ioo]);
  var4[3] = _mm256_loadu_pd(&y.data[12 + 16 * ioo]);
...
for (int_fast32_t ioi = 0; ioi < (((3 + n) / (4)) - 1) % 4; ioi++) {
  ...
  __m256d var4;
  var4 = _mm256_loadu_pd(&y.data[16 * ((((3 + n) / 4) - 1) / 4) + 4 * ioi]);
  var0 = _mm256_fmadd_pd(var3, var4, var0);
}
...
for (int_fast32_t ioo = 0; ioo < ((((7 + n) / (8)) - 1) / (4)); ioo++) {
  ...
  var4[0] = _mm256_loadu_ps(&y.data[32 * ioo]);
  var4[1] = _mm256_loadu_ps(&y.data[8 + 32 * ioo]);
  var4[2] = _mm256_loadu_ps(&y.data[16 + 32 * ioo]);
  var4[3] = _mm256_loadu_ps(&y.data[24 + 32 * ioo]);
...
for (int_fast32_t ioi = 0; ioi < (((7 + n) / (8)) - 1) % 4; ioi++) {
  ...
  __m256 var4;
  var4 = _mm256_loadu_ps(&y.data[32 * ((((7 + n) / 8) - 1) / 4) + 8 * ioi]);
  var0 = _mm256_fmadd_ps(var3, var4, var0);
}
