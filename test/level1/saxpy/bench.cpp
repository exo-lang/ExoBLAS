...
// BENCHMARK(BM_cblas_saxpy)->ArgNames({"n", "alpha", "incX", "incY",
...
//     });
// BENCHMARK(BM_exo_saxpy)->ArgNames({"n", "alpha", "incX", "incY",
// "alignmentX", "alignmentY"})->ArgsProduct({
//       benchmark::CreateRange((1 << 4), (1 << 24), (1 << 4)), {3}, {-4, 2, 4,
//       10}, {-4, 2, 1, 4, 10}, {64}, {64}
//     })->ArgsProduct({
//       benchmark::CreateRange((1 << 4) + 1, (1 << 24) - 1, 13), {3}, {-4, 2,
//       1, 4, 10}, {-4, 2, 1, 4, 10}, {64}, {64}
//     });
