...
BENCHMARK(BM_cblas_daxpy)->ArgNames({"n", "alpha", "incX", "incY", "alignmentX", "alignmentY"})->ArgsProduct({
      benchmark::CreateRange(1, (1 << 26), 2), {0, 1, 3}, {1}, {1}, {64}, {64}
    })->ArgsProduct({
      benchmark::CreateRange(7, (1 << 26) - 1, 7), {0, 1, 3}, {1}, {1}, {64}, {64}
    });
BENCHMARK(BM_exo_daxpy)->ArgNames({"n", "alpha", "incX", "incY", "alignmentX", "alignmentY"})->ArgsProduct({
      benchmark::CreateRange(1, (1 << 26), 2), {0, 1, 3}, {1}, {1}, {64}, {64}
    })->ArgsProduct({
      benchmark::CreateRange(7, (1 << 26) - 1, 7), {0, 1, 3}, {1}, {1}, {64}, {64}
    });
