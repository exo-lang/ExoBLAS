...
BENCHMARK(BM_cblas_srotm)
    ->ArgNames({"n", "HFlag", "incX", "incY", "alignmentX", "alignmentY"})
...
// BENCHMARK(BM_cblas_srotm)->ArgNames({"n", "HFlag", "incX", "incY",
...
//     {-1, 0, 1, -2}, {1}, {1}, {64}, {64}
//     });
// BENCHMARK(BM_exo_srotm)->ArgNames({"n", "HFlag", "incX", "incY",
// "alignmentX", "alignmentY"})->ArgsProduct({
//       benchmark::CreateRange(1, (1 << 26), 2),
//       {-1, 0, 1, -2}, {-4, 2, 4, 10}, {-4, 2, 1, 4, 10}, {64}, {64}
//     })->ArgsProduct({
