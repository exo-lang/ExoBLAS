...
void exo_scopy(const int N, const float *X, const int incX, 
                 float *Y, const int incY) {
    if (incX == 1 && incY == 1) {
        exo_scopy_stride_1(nullptr, N, 
...
void exo_dcopy(const int N, const double *X, const int incX, 
                 double *Y, const int incY) {
    if (incX == 1 && incY == 1) {
        exo_dcopy_stride_1(nullptr, N, 
