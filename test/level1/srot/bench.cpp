...
BENCHMARK(BM_cblas_srot)->ArgNames({"n", "incX", "incY", "c", "s", "alignmentX", "alignmentY"})->ArgsProduct({
      benchmark::CreateRange(1, (1 << 26), 2), {1}, {1}, {2}, {3}, {64}, {64}
    })->ArgsProduct({
      benchmark::CreateRange(7, (1 << 26) - 1, 7), {1}, {1}, {2}, {3}, {64}, {64}
    });
BENCHMARK(BM_exo_srot)->ArgNames({"n", "incX", "incY", "c", "s", "alignmentX", "alignmentY"})->ArgsProduct({
      benchmark::CreateRange(1, (1 << 26), 2), {1}, {1}, {2}, {3}, {64}, {64}
    })->ArgsProduct({
      benchmark::CreateRange(7, (1 << 26) - 1, 7), {1}, {1}, {2}, {3}, {64}, {64}
    });
