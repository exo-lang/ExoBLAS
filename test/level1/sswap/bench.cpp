...
// BENCHMARK(BM_cblas_sswap)->ArgNames({"n", "incX", "incY", "alignmentX",
...
//       10}, {-4, 2, 1, 4, 10}, {64}, {64}
//     });
// BENCHMARK(BM_exo_sswap)->ArgNames({"n", "incX", "incY", "alignmentX",
// "alignmentY"})->ArgsProduct({
//       benchmark::CreateRange((1 << 4), (1 << 24), (1 << 4)), {-4, 2, 4, 10},
//       {-4, 2, 1, 4, 10}, {64}, {64}
//     })->ArgsProduct({
