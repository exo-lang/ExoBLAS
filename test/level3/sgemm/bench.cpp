...
BENCHMARK(BM_SGEMM_CBLAS) -> ArgNames({"n"}) -> Args({4096});
BENCHMARK(BM_SGEMM_EXO) -> ArgNames({"n"}) -> Args({4096});

BENCHMARK(BM_SGEMM_CBLAS) -> ArgNames({"n"}) -> Args({2048});
BENCHMARK(BM_SGEMM_EXO) -> ArgNames({"n"}) -> Args({2048});
...
BENCHMARK(BM_SGEMM_CBLAS) -> ArgNames({"n"}) -> Args({128});
BENCHMARK(BM_SGEMM_EXO) -> ArgNames({"n"}) -> Args({128});

BENCHMARK(BM_SGEMM_CBLAS) -> ArgNames({"n"}) -> Args({64});
BENCHMARK(BM_SGEMM_EXO) -> ArgNames({"n"}) -> Args({64});
