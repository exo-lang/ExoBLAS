...
void test_dgemm(const enum CBLAS_TRANSPOSE transa,
  ...
  cblas_dgemm(CblasRowMajor, transa, transb, m, n, k, alpha, a.data(), m,
              b.data(), k, beta, c.data(), m);

  exo_dgemm(CblasRowMajor, transa, transb, m, n, k, &alpha, &beta, a.data(),
            b.data(), c2.data());
